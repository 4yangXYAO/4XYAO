...
const works = [
  ...
  { type: 'Jhasil Kerja Kami', title: 'Project Showcase', icon: 'fas fa-mobile-screen-button' },
];

const socials = [
  { href: 'https://github.com/4yangXYAO', icon: 'fab fa-github', label: 'GitHub' },
  { href: 'https://www.linkedin.com/in/4yangxyao', icon: 'fab fa-linkedin', label: 'LinkedIn' },
  { href: 'https://twitter.com/4yangXYAO', icon: 'fab fa-twitter', label: 'Twitter' },
  { href: 'https://www.instagram.com/1clayyy', icon: 'fab fa-instagram', label: 'Instagram' },
];
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white antialiased">
      ...
      <div className={`player-modal ${playerOpen ? 'open' : ''}`} id="playerModal">
        <div className="modal-top">
          <div className="disc-art">
            <i className="fas fa-compact-disc fa-spin" id="discIcon" ref={discRef}></i>
          </div>
          <button className="close-btn" id="closeBtn" type="button" onClick={closePlayer}>
        ...
        <div className="progress-wrap">
          ...
          <div className="progress-track" id="progressTrack" ref={progressRef} onClick={seekTrack}>
            <div className="progress-fill" id="trackFill" style={{ width: `${progress}%` }}></div>
            <div className="progress-dot" id="trackDot" style={{ left: `${progress}%` }}></div>
          </div>
        ...
        <div className="ctrl-wrap">
          <button className="ctrl-btn" id="prevBtn" type="button" onClick={() => goToTrack(currentTrack - 1)}>
            <i className="fas fa-backward-step"></i>
          </button>
          <button className="ctrl-btn ctrl-play" id="playBtn" type="button" onClick={togglePlay}>
            <i className={`fas ${playing ? 'fa-pause' : 'fa-play'}`} id="playIco"></i>
          </button>
          <button className="ctrl-btn" id="nextBtn" type="button" onClick={() => goToTrack(currentTrack + 1)}>
      ...
      <nav className={`navbar ${scrolled ? 'scrolled' : ''}`} id="navbar" ref={navRef}>
        <div className="nav-inner">
          <a href="#about" className="brand">
            <span className="brand-mark"></span>XYaoNLe's<span className="brand-dot">.</span>SERVICE<span className="brand-mark"></span>
          </a>
      ...
      <section className="about section" id="about">
        <div className="wrapper">
          <div className="section-head">
            <span className="section-label"><i className="fas fa-user"></i> Tentang Kami</span>
            <h2 className="section-heading">Kenali Lebih Dalam <span className="accent">Siapa Kami</span></h2>
          </div>
      ...
      <section className="services section" id="services">
        <div className="wrapper">
          <div className="section-head">
            <span className="section-label"><i className="fas fa-gear"></i> Layanan</span>
            <h2 className="section-heading">Apa yang Saya <span className="accent">Tawarkan</span></h2>
            <p className="section-desc">Layanan profesional yang saya sediakan, silahkan tap/click pada layanan yang Anda butuhkan.</p>
          </div>
          <div className="grid-services">
            {services.map((service) => (
              ...
              >
                <div className="srv-card" data-delay={service.delay} style={{ '--icon-color': service.color }}>
                  ...
                  <div className="price-tag">Mulai dari <strong>Rp xxx</strong></div>
                </div>
              </a>
            ))}
          </div>
      ...
      <section className="skills section" id="skills">
        <div className="wrapper">
          <div className="section-head">
            <span className="section-label"><i className="fas fa-chart-bar"></i> Tech Stack</span>
            <h2 className="section-heading">Skill & <span className="accent">Teknologi</span></h2>
          </div>
      ...
      <section className="works section" id="portfolio-work">
        <div className="wrapper">
          <div className="section-head">
            <span className="section-label"><i className="fas fa-folder-open"></i> Lebih Lengkap Tentang Kami</span>
            <h2 className="section-heading">Portofolio <span className="accent">Kami</span></h2>
          </div>
          <div className="grid-works">
            {works.map((work) => (
              <div className="work-item" key={work.title}>
                <div className="thumb-wrap">
                  <div className="thumb-inner"><i className={work.icon}></i></div>
                  <div className="thumb-overlay">
                    <a href="#" className="view-link" onClick={(event) => event.preventDefault()}>
                      <i className="fas fa-arrow-up-right-from-square"></i> Lihat Proyek
                    </a>
                  </div>
                </div>
      ...
      <section className="contact section" id="contact">
        <div className="wrapper">
          <div className="section-head">
            <span className="section-label"><i className="fas fa-envelope"></i> Kontak</span>
            <h2 className="section-heading">Mari <span className="accent">Bekerja Sama</span></h2>
            <p className="section-desc">punya Proyek di luar menu, maupun spesial request? silahkan diskusikan dengan kami !</p>
          </div>
          <div className="contact-layout">
            <div className="info-side">
              <div className="info-row">
                <div className="icon-badge"><i className="fas fa-envelope"></i></div>
                <div>
                  <strong>Email</strong>
                  <p>@gmail.com</p>
                </div>
              ...
              <div className="info-row">
                <div className="icon-badge">
                  <a href="https://wa.me/62895330107704" target="_blank" rel="noreferrer" className="soc-btn">
              ...
              <div className="info-row">
                <div className="icon-badge">
                  <a href="https://www.instagram.com/1clayyy" target="_blank" rel="noreferrer" className="soc-btn">
              ...
              <div className="social-row">
                {socials.map((social) => (
                  <a href={social.href} target="_blank" rel="noreferrer" className="soc-btn" key={social.label} aria-label={social.label}>
            ...
            <form className="form-side" id="contactForm" onSubmit={handleSubmit}>
              <div className="field">
              ...
              <div className="field">
                ...
                <textarea id="message" name="message" rows="5" placeholder="Ceritakan proyek Anda..." required></textarea>
              </div>
              <button type="submit" className="btn btn-solid btn-block" disabled={formState === 'loading'}>
                {formState === 'loading' ? <><i className="fas fa-spinner fa-spin"></i> Mengirim...</> : formState === 'success' ? <><i className="fas fa-check"></i> Pesan Terkirim!</> : formState === 'error' ? <><i className="fas fa-triangle-exclamation"></i> Gagal Mengirim</> : <><i className="fas fa-paper-plane"></i> Kirim Pesan</>}
              </button>
            </form>
          </div>
        </div>
      ...
      <footer className="site-footer">
        <div className="wrapper">
          <div className="footer-inner">
            <p>&copy; 2026 <span className="accent">XYaoLe's Service</span>. All rights reserved.</p>
            <p className="footer-sub">Built with <i className="fas fa-heart" style={{ color: '#e11d48' }}></i>,Coffee, Rokok, abis itu kena paru-paru, sakit 2 hari</p>
          </div>
        </div>
      </footer>
